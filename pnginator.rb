...
html = "<head><style type='text/css'>body{background:#000 linear-gradient(0, rgba(27,1,22,1) 0%, rgba(6,3,13,1) 72%, rgba(13,0,25,1) 100%);margin:0;padding:0;overflow:hidden;width:100%;height:100%}canvas{position:absolute;right:0;bottom:0;animation: bounce 2s infinite ease-in-out;}
...
</style></head><body><canvas id='c' style='display:none;'><img onload=for(w=c.width=#{width},a=c.getContext('2d'),a.drawImage(this,p=0,0),e='',d=a.getImageData(0,0,w,#{height}).data;t=d[p+=4];)e+=String.fromCharCode(t);(1,eval)(e) src=#>"
