...
html = "<head><style type='text/css'>body{background:#000;margin:0;padding:0;}canvas{position:absolute;right:0;bottom:0}</style></head><body><canvas id='c' style='display:none;'><img onload=for(w=c.width=#{width},a=c.getContext('2d'),a.drawImage(this,p=0,0),e='',d=a.getImageData(0,0,w,#{height}).data;t=d[p+=4];)e+=String.fromCharCode(t);(1,eval)(e) src=#>"
